...
const Navbar = () => {
  ...
  return (
    <nav className='navbar'>
      ...
      <div className='navbar-main bg-yellow'>
        <div className='container'>
          <div className='navbar-main-top flex align-center justify-between'>
            <Link to = "/" className='navbar-brand'>
              <span className='text-red fs-26 fw-6'>Jum</span>
              <span className='text-white fs-26 fw-6'>ia.</span>
            </Link>
          ...
          <div className='navbar-main-bottom flex align-center justify-between'>
            <div className = "navbar-cats-wrapper">
              <div className='navbar-cats-btn flex align-center text-dark px-2 py-2' onClick={toggleCategory}>
                <AiOutlineBars />
                <span className = "text-uppercase text-dark mx-3 fs-13">all categories</span>
                <BsCaretDownFill />
              </div>
